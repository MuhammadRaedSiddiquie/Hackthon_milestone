    ...
    <section className='w-full h-[80vh] bg-blueCol flex items-center justify-center py-[112px] relative'>
      <div className='w-[73%] flex items-center relative z-10'>
        <div className='flex flex-col py-[48px] gap-[35px] items-start max-md:items-center'>
          ...
          <p className='montserrat-regular text-white text-[20px] tracking-[0.2px] w-[70%] max-md:w-full max-md:text-center max-md:px-8 xxl:text-2xl'>We know how large objects will act
          but things on a small scale</p>
          <button className='bg-[#2DC071] py-[15px] px-[40px] montserrat-bold text-[20px] text-white rounded-[5px] hover:bg-[#26a05e] xxl:text-2xl'>SHOP NOW</button>
        </div>
      </div>
