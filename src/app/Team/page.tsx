        ...
        <main className='w-full flex flex-col items-center justify-start'>
            <div className='w-full flex items-center flex-col'>
                <div className='w-[73%] flex flex-col items-center gap-[16px] py-[50px]'>
                    <h4 className='montserrat-bold text-base text-secondaryCol xxl:text-[22px]'>WHAT WE DO</h4>
                    ...
                    <div className='flex items-center gap-[4px]'>
                        ...
                        <p className='montserrat-regular text-secondaryCol text-sm xxl:text-xl'>Team</p>
                    </div>
                </div>
