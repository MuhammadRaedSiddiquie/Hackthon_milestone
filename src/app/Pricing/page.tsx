    ...
    return (
        <main className='w-full flex flex-col items-center justify-start'>
            <div className='w-[73%] flex flex-col items-center py-[50px] gap-[16px] max-md:w-[90%]'>
                <h4 className='montserrat-bold text-secondaryCol text-base xxl:text-[22px]'>PRICING</h4>
                ...
                <div className='w-full flex items-center justify-center py-[24px] max-md:justify-center'>
                    <div className='flex items-center gap-[4px]'>
                        ...
                        <p className='montserrat-regular text-secondaryCol text-sm xxl:text-xl'>Pricing</p>
                    </div>
                </div>
            ...
            <div className='w-[73%] flex flex-col py-[48px] items-center gap-[48px] max-md:w-[90%]'>
                <div className='flex flex-col items-center gap-[12px]'>
                    ...
                    <h4 className='montserrat-regular text-secondaryCol text-sm text-center xxl:text-xl'>Problems trying to resolve the conflict between
                        the two major realms of Classical physics: Newtonian mechanics </h4>
                </div>
                <div className='flex items-center gap-8'>
                    <div className='flex gap-2 items-center'>
                        <h4 className='montserrat-bold text-primaryCol text-sm xxl:text-xl'>Monthly</h4>
                        <PiToggleRightDuotone className='text-blueCol text-5xl' />
                    </div>
                    <div className='flex gap-2 items-center'>
                        <h4 className='montserrat-semibold text-primaryCol text-sm xxl:text-xl'>Yearly</h4>
                        <button className='rounded-[38px] text-blueCol text-sm bg-[#B2E3FF] px-[20px] py-[10px] xxl:text-xl'>SAVE 20%</button>
                    </div>

                </div>
            </div>
            <div className='w-[73%] flex items-center justify-center gap-4 max-md:flex-col max-md:w-[90%]'>
            ...
            <div className='w-[73%] flex flex-col items-center py-[24px] gap-[30px] max-md:w-[90%]'>
                <div className='w-full flex flex-col items-center py-[45px] gap-[10px]'>
                    ...
                    <p className='montserrat-regular text-secondaryCol text-[20px] text-center max-md:text-base xxl:text-2xl'>Problems trying to resolve the conflict between
